...
break;
case 5:
this.$ = yy.compileInfo.functionsTable.addFunction({...$$[$0-2], body: $$[$0-1]}, _$[$0-2].first_column + 1, _$[$0-2].first_line);;
break;
case 6:
this.$ = $$[$0-1].execute();
break;
...
break;
case 71:addError.apply(this, [`El token <<${yy_.yytext}>> no se reconocio dentro de la gramatica.`, 0, yy_.yylloc]);
break;
}
},
